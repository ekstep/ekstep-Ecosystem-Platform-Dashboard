define(function (require) {
  return function SecondaryYAxisFactory(d3, Private) {
    ...
    _(SecondaryYAxis.prototype).extend(ErrorHandler.prototype);
    ...
    SecondaryYAxis.prototype._isUserDefined = function () {
      return (this._attr.setYExtents);
    };

    SecondaryYAxis.prototype._isYExtents = function () {
      return (this._attr.defaultYExtents);
    };

    SecondaryYAxis.prototype._validateUserExtents = function (domain) {
      var self = this;
    ...
    SecondaryYAxis.prototype._getExtents = function (domain) {
      var min = domain[0];
      var max = domain[1];
    ...
    SecondaryYAxis.prototype._throwCustomError = function (message) {
      throw new Error(message);
    };

    SecondaryYAxis.prototype._throwLogScaleValuesError = function () {
     ...
     * @returns {*}
     */
    SecondaryYAxis.prototype._getScaleType = function (fnName) {
     ...
     * @returns {*[]}
     */
    SecondaryYAxis.prototype._logDomain = function (min, max) {
     ...
     */
    SecondaryYAxis.prototype.getYScale = function (height) {
    ...
    SecondaryYAxis.prototype.getScaleType = function () {
      return this._attr.scale;
    };

    SecondaryYAxis.prototype.tickFormat = function () {
    ...
    SecondaryYAxis.prototype._validateYScale = function (yScale) {
     ...
     */
    SecondaryYAxis.prototype.getYAxis = function (height) {
     ...
     */
    SecondaryYAxis.prototype.tickScale = function (height) {
     ...
     */
    SecondaryYAxis.prototype.draw = function () {
      var self = this;
